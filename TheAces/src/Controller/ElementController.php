...
class ElementController extends AbstractController
{
    ...
    public function show($id): Response
    {
        ...
        return $this->render('element/elementShow.html.twig', [
            'element' => $element,
        ]);
    }
     ...
     */
    public function AfficherElement(Request $request,PaginatorInterface $paginator)
    {
        $repo = $this->getDoctrine()->getRepository(Element::class);
        $element = $repo->findAll();

        $elements = $paginator->paginate(
            $element, // Requête contenant les données à paginer (ici nos articles)
            $request->query->getInt('page', 1), // Numéro de la page en cours, passé dans l'URL, 1 si aucune page
            4// Nombre de résultats par page
        );


        return $this->render('element/AfficherElement.twig', ["element" => $elements]);
        }
    ...
    public function modifier($id,Request $req)
    {
        ...
        return $this->render('element/modifierElement.html.twig', [
