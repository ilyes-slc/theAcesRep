...
class LivraisonController extends AbstractController
{
    ...
    {
        return $this->render('nabil/livraison/livraison.html.twig', [
    ...
    {
        return $this->render('nabil/baseFront.html.twig', [
    ...
    public function afficher(Request $request,PaginatorInterface $paginator)
    {
        ...
        return $this->render('nabil/back/livraison.html.twig',['livraison'=>$Livraison]);
    ...
    {   $Livraison=new Livraison();
     ...
     return $this->render('nabil/livraison/detail.html.twig',['livraisonForm'=>$form->createView(),'l'=>$Livreur]);
    ...
    public function modifier($id,Request $req)
    {
        ...
        return $this->render('nabil/livraison/modifier.html.twig',['livraison1Form'=>$form->createView()]);
    ...
    {
        $Livraison=$this->getDoctrine()->getRepository(Livraison::class)->findAll();
        return $this->render('nabil/test/afficherFront.html.twig',['livraison'=>$Livraison]);
    ...
    { $Livreur=$this->getDoctrine()->getRepository(Livreur::class)->find($cin);
        return $this->render('nabil/livraison/map.html.twig',['l'=> $Livreur]);
    }
    ...
    public function mapsB()
    {
        ...
        return $this->render('nabil/back/mapBack.html.twig');
    }
 ...
 /**
    ...
    public function list(LivraisonRepository $LivraisonRepository, Request $request): Response
    {
        ...
        $html = $this->renderView('nabil/livraison/pdf.html.twig', [
            'livraison' => $Livraison,
        ]);
